...
class Milestone extends BaseModel
{
     ...
     */
    protected $fillable = [
        'title', 'description', 'comments', 'enabled', 'due_date', 'status_id', 'priority_id',
    ];
     ...
     * @var string
     */
    public $resource_route_name   = "todomilestones";
     ...
     * @var string
     */
    public $classname_formprocessor_delete = 'DeleteMilestoneFormProcessing';
    ...
    public $field_list = [
        ...
        [
            'name'                  => 'due_date',
            'type'                  => 'date',
            'info'                  => 'Optional, but probably better to guess a date.',
            'index_skip'            => false,
            'index_align'           => 'center',
